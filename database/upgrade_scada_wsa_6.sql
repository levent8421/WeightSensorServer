...
alter table t_temperature_humidity_sensor
    add column max_temperature decimal(6, 3) not null comment 'Max Temperature',
    add column min_temperature decimal(6, 3) not null comment 'Min Temperature',
    add column max_humidity decimal(6, 3) not null comment 'Max humidity',
    add column min_humidity decimal(6, 3) not null comment 'Min humidity';
